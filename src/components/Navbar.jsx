      ...
      <div className="flex justify-between items-center h-16">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-200">Web Developer , Data Analyst</p>
          </div>
        </div>
...
// import { IoCloseSharp } from "react-icons/io5";
// import { Link } from "react-scroll";
// // 1. Import the typewriter component
...
//             <h1 className="text-xl font-bold leading-none">Avinash Kumar</h1>
//             {/* 2. Logic to show Web Developer first, then Data Analyst */}
...
//         <div
//           className="
//             md:hidden absolute top-16 left-0 w-full h-[calc(100vh-4rem)]
//             bg-gradient-to-b from-indigo-600 to-purple-700
